...
func expandPacketFilterExpressions(exprs []*sakuraPacketFilterExpressionModel) []*iaas.PacketFilterExpression {
...
func expandPacketFilterExpression(expr *sakuraPacketFilterExpressionModel) *iaas.PacketFilterExpression {
	action := "deny"
