...
func (d *packetFilterDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			"id":          schemaDataSourceId("Packet Filter"),
			"name":        schemaDataSourceName("Packet Filter"),
			"description": schemaDataSourceDescription("Packet Filter"),
			"zone":        schemaDataSourceZone("Packet Filter"),
			"expression": schema.ListNestedAttribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"description": schemaDataSourceDescription("Packet Filter Expression"),
					},
				},
			},
		},
