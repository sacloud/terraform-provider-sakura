...
func (d *simpleMQDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			"id":          schemaDataSourceId("SimpleMQ"),
			"name":        schemaDataSourceName("SimpleMQ"),
			"description": schemaDataSourceDescription("SimpleMQ"),
			"icon_id":     schemaDataSourceIconID("SimpleMQ"),
