...
func xflattenSimpleMonitorHealthCheck(simpleMonitor *iaas.SimpleMonitor) []interface{} {
...
func xexpandSimpleMonitorHealthCheck(d resourceValueGettable) *iaas.SimpleMonitorHealthCheck {
