...
page_title: "sakura_apprun_dedicated_load_balancer Data Source - sakura"
subcategory: "Computing"
description: |-
  Information about an AppRun dedicated load balancer
---

# sakura_apprun_dedicated_load_balancer (Data Source)
...
- `auto_scaling_group_id` (String) The auto scaling group ID that the load_balancer belongs to
- `cluster_id` (String) The cluster ID that the load_balancer belongs to
