...
page_title: "sakura_service_endpoint_gateway Data Source - sakura"
subcategory: "Networking"
description: |-
  Get information about an existing seg.
---

# sakura_service_endpoint_gateway (Data Source)
...
- `app_run_dedicated_control_enabled` (Boolean) The flag to enable AppRun Dedicated Control Plane endpoint on the Service Endpoint Gateway
