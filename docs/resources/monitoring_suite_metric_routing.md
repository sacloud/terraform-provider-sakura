...
page_title: "sakura_monitoring_suite_metric_routing Resource - sakura"
subcategory: "Monitoring"
description: |-
  Manages a Monitoring Suite Metric Routing.
...
# sakura_monitoring_suite_metric_routing (Resource)
...
- `created_at` (String) The creation timestamp of the Monitoring Suite Metric Routing
- `id` (String) The ID of the Monitoring Suite Metric Routing.
- `updated_at` (String) The last update timestamp of the Monitoring Suite Metric Routing
