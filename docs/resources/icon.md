...
page_title: "sakura_icon Resource - sakura"
subcategory: "Misc"
description: |-
  Manages an Icon.
---

# sakura_icon (Resource)
...
- `base64content` (String) The base64 encoded content to upload as the Icon.
- `source` (String) The file path to upload as the Icon.
